...
def main_page(request):
    ...
    if request.user.is_authenticated():
        ...
        idea_list = Idea.objects.filter(owner=current_user, parent=None).order_by('modified_date').reverse()
...
#            number_of_pages = number_of_pages/results_per_page
        ...
        return render_to_response('home.html', { 'user' : current_user, 'idea_list' : idea_list }, context_instance=context)
    else:
